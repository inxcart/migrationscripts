...
UPDATE `PREFIX_tax_rules_group` SET `date_add` = NOW(), `date_upd` = NOW() WHERE CAST(`date_add` AS CHAR(20)) = '0000-00-00 00:00:00';

ALTER TABLE  `PREFIX_order_detail` ADD  `original_wholesale_price` DECIMAL( 20, 6 ) NOT NULL DEFAULT  '0.000000';

/* PHP:ps1_6_1_1_alter_ignore_drop_key(specific_price, id_product_2); */;
